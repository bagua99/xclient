local M = class("FailedLayer",function()
...
function M:ctor(gameid,tInfo,isTotalConclude,isBanker,bankerId,isXiazhuang,isShangZhuang)
	local node = cc.CSLoader:createNode("res/"..gameid.."/FailedEndLayer.csb");
	node:addTo(self)
	self.root = node
...
function M:initView(gameid,tInfo,isTotalConclude,isBanker,bankerId,isXiazhuang,isShangZhuang)
    ...
    for i = 1, items_count do
        ...
        local color1 = cc.c4b(116,217,51,255)
        local color2 = cc.c4b(42,135,188,255)
        Name:setTextColor(color)
       	Yazhu:setTextColor(color1)
       	TypeText:setTextColor(color)
       	Score:setTextColor(color2)
